...
module.exports = {
  user          : process.env.NODE_ORACLEDB_USER || "citydemo",

  // Instead of hard coding the password, consider prompting for it,
  // passing it in an environment variable via process.env, or using
  // External Authentication.
  password      : process.env.NODE_ORACLEDB_PASSWORD || "citydemo",

  // For information on connection strings see:
  // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=dbs.zgik.priv)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SID=DBS)))",
  //"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=dbs.zgik.priv)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SID=DBS)))"
